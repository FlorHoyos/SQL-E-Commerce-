...
This project analyzes the Olist Brazilian E-Commerce dataset using PostgreSQL and Tableau. I built structured SQL queries to explore **sales trends**, **category performance**, and **seller concentration patterns**, transforming raw transactional data into business insights about marketplace health, customer purchasing behavior, and seller dependency risk.
...
This is the most advanced part of the project. For each category, I computed:
...
- Where does bundling behavior occur?  
